  ...
  const handleStart = async () => {
    ...
    if (!poem) {
      ...
      try {
        ...
        setPoem("Selamat ulang tahun, Sayang. Semoga bahagia selalu bersamaku.");
      } finally {
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
              {MEMORIES.map((m, i) => (
                ...
                >
                  <img src={m.url} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-125" loading="lazy" />
